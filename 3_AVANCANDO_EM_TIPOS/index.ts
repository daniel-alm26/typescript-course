...
const nomes: string[] = ["Daniel", "João"]
...
const pessoaObj: { nome: string, surname: string } = { nome: "Daniel", surname: "Cardoso" }
...
// 12 - type alias
type ID = string | number // Ajuda a diminuir uma sentença para podermos utilizar em vários lugares.
...
const somePerson:Person = {name: "Daniel", age: 42}
